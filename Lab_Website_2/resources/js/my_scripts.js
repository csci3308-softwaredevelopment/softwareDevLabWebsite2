...
*/
		...
		function changeColor(color) {
			var homePage = document.body.style.backgroundColor = color;
		}
...
*/
		...
		function switchPlayers(playerNum) {
			...
			document.getElementById("avg_p_yards").innerHTML = (player.pass_yards/player.games_played).toFixed(0);

			document.getElementById("r_yards").innerHTML = player.rushing_yards;

			document.getElementById("avg_r_yards").innerHTML = (player.rushing_yards/player.games_played).toFixed(0);

			document.getElementById("rec_yards").innerHTML = player.receiving_yards;

			document.getElementById("avg_rec_yards").innerHTML = (player.receiving_yards/player.games_played).toFixed(0);
		}
